...
# setting user menggunakan akun google, di bagian:
# AUTH_USER_MODEL, AUTHENTICATION_BACKENDS, INSTALLED_APPS, MIDDLEWARE_CLASSES
# ref documentation : https://djangae.readthedocs.org/en/latest/gauth/
# documentation section: Using the Datastore
...
# add shared templates directory
TEMPLATE_DIRS = (
...
if DEBUG:
    CSP_STYLE_SRC = ("'self'", "'unsafe-inline'", "https://maxcdn.bootstrapcdn.com", "fonts.googleapis.com", "*.gstatic.com")
    CSP_FONT_SRC = ("'self'", "https://maxcdn.bootstrapcdn.com", "fonts.googleapis.com", "*.gstatic.com")
else:
